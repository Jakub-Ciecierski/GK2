...
{
	//TODO: Bind any additional vertex shader buffers DONE
	ID3D11Buffer* vsb[5] = { m_worldCB->getBufferObject().get(), m_viewCB->getBufferObject().get(),
							 m_projCB->getBufferObject().get(),
							m_textureMtxCB->getBufferObject().get(), m_textureMtxCB2->getBufferObject().get()
						   };
...
void MultiTexEffect::SetPixelShaderData()
{
	...
	//TODO: Bind any additional textures DONE
